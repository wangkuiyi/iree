...
typedef struct iree_hal_metal_buffer_copy_spec {
...
} iree_hal_metal_buffer_copy_spec;
...
iree_status_t iree_hal_metal_builtin_executable_copy_buffer(
  ...
  const unsigned workgroup_size = 32;
  unsigned workgroup_count = iree_hal_metal_ceil_div(length, workgroup_size * 4);

  iree_hal_metal_buffer_copy_spec spec = {
